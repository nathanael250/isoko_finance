    ...
    return (
        <div className='min-h-screen bg-gray-200'>
            <div className="max-w-7xl mx-auto px-4 sm:px-2 lg:px-2 py-4 space-y-4">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold text-gray-900 mb-2">No repayments loans</h1>
                    ...
                    <form action="" className='text-sm'>
                        <div className='flex flex-col gap-y-2 gap-x-2'>
                            ...
                            <div className='flex justify-between gap-8'>
                                ...
                                />
                                <select name="" id="" className='border border-slate-300 flex-1 focus-outline-none rounded-sm text-slate-300'>
...
export default NoRepaymentsLoans
