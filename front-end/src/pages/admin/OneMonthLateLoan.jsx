    ...
    return (
        <div className='min-h-screen bg-gray-200'>
            <div className="max-w-7xl mx-auto px-4 sm:px-2 lg:px-2 py-4 space-y-4">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold text-gray-900 mb-2">1 Month Late Loans</h1>
                    <p className="text-gray-600 text-sm">
                        This shows loans overdue by 30 days ore more. This is calculated from the loan schedule for loans that are Missed Repayment, Arrears, or Past Maturity. We look at the last loan schedule date where the balance was 0 and then calculate the number of days between that schedule date and today.
                    </p>
                </div>
                {/* <div className=''>
                ...
                <div className='bg-white px-2 py-4 border-t-2 border-green-500'>
                    <form action="" className='text-sm'>
                        <div className='flex flex-col md:flex-row gap-y-2 gap-x-2 items-center justify-between'>
                            <label htmlFor="" className='font-semibold'>Overdue By:</label>
...
export default OneMonrhLateLoan
